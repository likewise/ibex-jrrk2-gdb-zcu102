...
int main(int argc, char **argv) {
  ibex_super_system_verilator top;
  VerilatorMemUtil memutil;
  VerilatorSimCtrl &simctrl = VerilatorSimCtrl::GetInstance();
  simctrl.SetTop(&top, &top.IO_CLK, &top.IO_RST_N,
                 VerilatorSimCtrlFlags::ResetPolarityNegative);

  MemArea ram("TOP.ibex_super_system_verilator.u_super_system.u_ram.u_ram.gen_generic.u_impl_generic",
              1024 * 1024 / 4, 4);
  ...
  svSetScope(svGetScopeFromName("TOP.ibex_super_system_verilator.u_super_system"));
