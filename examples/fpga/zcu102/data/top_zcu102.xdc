...
# assume zero delay on a button (do not care)
...
create_clock -name tck -period 50 -waveform {0 25}     [get_pins -filter { NAME =~ "*/INTERNAL_TCK" } -of_objects [get_cells -hierarchical -filter { PRIMITIVE_TYPE =~ *.BSCANE2 }]]
